...
{
	_element.atSlider = setInterval(alijkh_slider_next.bind(_element), 1500);
...
function mouse_out (_element)
{
	// _element.atSlider = setInterval(alijkh_slider_next.bind(this), 1500);
	 // setInterval(alijkh_slider_next.bind(_element), 1500);
	 // setInterval(alijkh_slider_next(),1500);
	 // setInterval(this.atSlider.bind(_element), 1500);
	timerSlider = setInterval(alijkh_slider_next.bind(_element), 1500);
